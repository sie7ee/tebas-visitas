...
(function(a,b){
      ...
      var f=(JSON||{}).stringify,g=Array.prototype.slice,h,i="undefined",j="item.manager",k="plugins",l="ext",m="html.wrap",n="html.hidden",o="keys",p="preInvalidate",q="postInvalidate",r="getFormData",s="setFormData",t="setInputData",u="postInit",v="ready",w={
      itemManager:d,
      plugins:[],
      ext:{},
      html:{
...
if(!f)throw new Error("JSON.stringify() not found");
      ...
      for(d in c)b.push(d);this.initPlugins(b,c)
...
for(i=0;i<h.length;i++)h[i].init(d)
      ...
      var c=this,d={},e=0;
      c.trigger(a,d,b);
      for(var f in d)e=Math.max(e,f);return d[e]
...
(function(a){
      ...
      var c=b.prototype,d="ajax.data.callback",e="ajax.cache.results",f="ajax.loading.delay",g="ajax.loading.message",h="ajax.type.delay",i="setSuggestions",j="showDropdown",k="loading",l={
            ajax:{
                  typeDelay:.5,
...
(function(a){
      ...
      var c=b.prototype,d="html.arrow",e={
            html:{
...
(function(a){
      ...
      var c=b.prototype,d="filter.enabled",e="filter.items",f={
            filter:{
                  enabled:!0,
                  items:null
            }
...
(function(a){
      ...
      var c=b.prototype,d="html.focus",e={
            html:{
...
(function(a){
      ...
      var c=b.prototype,d="text-hide-prompt",e="prompt",f="html.prompt",g={
...
(function(a){
      ...
      var c=b.prototype,d="suggestions",e={
            suggestions:null
      };
...
(function(a){
      ...
      var c=b.prototype,d=".",e="text-tags-on-top",f=d+e,g="text-tag",h=d+g,i="text-tags",j=d+i,k="text-label",l=d+k,m="text-remove",n=d+m,o="tags.enabled",p="tags.items",q="html.tag",r="html.tags",s="isTagAllowed",t="tagClick",u={
            tags:{
                  enabled:!0,
                  items:null
            },
