<h3 class="ui-widget-header"><?php echo __("Editar Empresa [" . $this->data['Empresa']['id'] . "]",true); ?></h3>
<div id="tabs">
...
<script type="text/javascript" src="/js/implementaciones/empresas/edit.js"></script>