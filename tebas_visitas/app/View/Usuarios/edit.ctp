<div id="Form" title="<?php echo __("Editar Usuario [ ".$this->data['Usuario']['id']." ]",true);?>">
	<?php echo $this->Form->create("Usuario", array('action' => 'edit','onkeypress'=>'return event.keyCode!=13','id' => 'Form00')); ?>
        ...
        <div id="tabs-2"> 
			<table width="100%" border="0"  cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<td width="2%"><?php echo $this->Html->image('error.png' , array('align' => 'right','name' => 'clave_secreta_repite','id' => 'img_error','style' => 'display:none;')); ?></td>
			  </tr>				  
			</table>		
		</div>	
	</div>
