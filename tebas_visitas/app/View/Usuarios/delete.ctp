<div id="Form" title="<?php echo __("Eliminar Usuario [ ".$this->data['Usuario']['id']." ] ahora ?",true);?>">
	<?php echo $this->Form->create("Usuario", array('action' => 'delete','onkeypress'=>'return event.keyCode!=13','id' => 'Form00')); ?>
    ...
    <div id="tabs">   
        ...
        <div id="tabs-2"> 
			<table width="100%" border="0"  cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				<td><?php echo $this->Form->input('clave_secreta', array('type'=>'password','label' =>__("Contraseña *",true),'maxlength' =>'150', 'style' => 'width:99%;','id'=>'clave_secreta','value'=>'','class'=>'ui-widget-content ui-corner-all'));?></td>
				<td width="2%"><?php echo $this->Html->image('error.png' , array('align' => 'right','name' => 'clave_secreta','id' => 'img_error','style' => 'display:none;')); ?></td>
			  </tr> 
			  <tr>
				<td><?php echo $this->Form->input('clave_secreta_repite', array('type'=>'password','label' =>__("Confirmar Contraseña *",true),'maxlength' =>'150', 'style' => 'width:99%;','id'=>'clave_secreta_repite','value'=>'','class'=>'ui-widget-content ui-corner-all'));?></td>
				<td width="2%"><?php echo $this->Html->image('error.png' , array('align' => 'right','name' => 'clave_secreta','id' => 'img_error','style' => 'display:none;')); ?></td>
			  </tr>				  
			</table>		
		</div>	
	...
	<span id="cmdaceptar" style="display:none;"><?php echo __("Si",true);?></span>
	<span id="cmdcancelar" style="display:none;"><?php echo __("No",true);?></span>
</div>