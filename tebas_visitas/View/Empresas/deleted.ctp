<h3 class="ui-widget-header"><?php echo __("Eliminar Empresa [ " .$this->data['Empresa']['id'].  " ]",true); ?></h3>
<div id="tabs">
   ...
   <?php echo $this->Form->create("Empresa", array('action' => 'deleted', 'type' => 'file', 'onkeypress' => 'return event.keyCode!=13', 'id' => 'Form00', 'class' => 'form-horizontal')); ?>
