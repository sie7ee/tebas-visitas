<?php echo $this->Html->script("implementaciones/perfiles/add",false);?>	
<h3 class="ui-widget-header"><?php echo __("Nuevo Perfil",true); ?></h3>
<?php echo $this->Form->create("Perfile", array('action' => 'add','label'=>false,'id' => 'Form00','inputDefaults'=>array("div"=>false,'error'=>array('attributes' => array('wrap' => 'label','class'=>'label label-warning')) ) )); ?>
      <fieldset>
