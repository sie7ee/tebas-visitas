...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
   <head>
	...
	<?php
		...
		echo $this->Html->css('font-awesome');
          ...
          echo $this->Html->css('application');echo $this->Html->css('bootstrap');	
   ...
   <body>
            ...
            <div class="container">
               ...
               <div id="top-nav">
                  ...
                  <ul class="pull-right">
                     ...
                     <li>
						<?php echo $this->Html->link("Cerrar Session",array('controller'=>"usuarios",'action'=>"logout"));?> 					 					 
					 </li>
                  </ul>
      ...
      <?php 
            ...
            //echo $this->Html->script('jquery-ui-1.8.24.custom.min');
